                ...
                <div className="mx-auto  container py-8">
                    <div className="flex flex-wrap items-center lg:justify-between justify-center">
                        ...
                        <div className="mx-2 w-72 lg:mb-0 mb-8">
                            <div>
                                <img src="http://www.bedbreakfast.ee/wp-content/uploads/2016/10/hostel.jpg" className="w-full h-44" />
                            </div>
                            <div className="bg-white">
                                <div className="flex items-center justify-between px-4 pt-4">
                                    ...
                                    <div className="bg-yellow-200 py-1.5 px-6 rounded-full">
                                        <p className="text-xs text-rose-600">Featured</p>
                                    </div>
                                </div>
                                <div className="p-4">
                                    ...
                                    <div className="flex items-center justify-between py-4">
                                        <h2 className="hover:text-white 0  text-xs font-semibold"><button className='p-2 rounded hover:bg-yellow-400 border-yellow-400 border px-4' type="">Book Now</button></h2>
