                                ...
                                myOrders?.map((item) => (<div className="mt-6 md:mt-0 flex justify-start flex-col md:flex-row  items-start md:items-center space-y-4  md:space-x-6 xl:space-x-8 w-full mb-5">
                                    ...
                                    <div className="  flex justify-between items-start w-full flex-col md:flex-row space-y-4 md:space-y-0  ">
                                        <div className="w-full flex flex-col justify-start items-start space-y-2">
                                            <h3 className="text-xl xl:text-2xl font-semibold leading-6 text-secondary ">{item.name}</h3>
                                        ...
                                        <div className="lg:flex justify-between items-center  mx-auto lg:space-x-8  w-full">
...

                                            {
                                                item?.status ?
                                                    " " :
                                                    <p className="text-base xl:text-lg  leading-6 text-secondary"> <label  className=" uppercase btn  text-white cursor-pointer btn-primary">Cancel</label>
                                                    </p>
                                            }
                                        </div>
                                    </div>
