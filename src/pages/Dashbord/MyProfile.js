            ...
            <div class="w-full mt-16 mx-auto max-w-xl rounded-lg bg-white dark:bg-gray-800 shadow-lg px-5 py-4 text-gray-800 dark:text-gray-50">
                <div class="w-full pt-1 text-center -mt-16 mx-auto">
                    <a href="#" class="block relative">
                        <img alt="profil" src={details.image || user?.photoURL} class="mx-auto object-cover rounded-full h-20 w-20 "/>
                    </a>
                </div>
                <div class="w-full">
                    ...
                    <div class="rounded-lg bg-pink-100 dark:bg-white p-2 w-full mb-4">
                        ...
                        <h1 className='font-bold text-2xl'>About</h1>
                            ...
                            {
                                details.number&&<div className='flex  items-start mx-5'>
                                <div>
                                    <p class="font-bold">
                                    Number: 
                                    </p>
                            ...
                            {
                                details.education&&<div className='flex  items-start mx-5'>
                                <div>
                                    <p class="font-bold">
                                    Education: 
                                    </p>
                            ...
                            {
                                details.location&&<div className='flex  items-start mx-5'>
                                <div>
                                    <p class="font-bold">
                                    Location: 
                                    </p>
