...
const ManageRoom = () => {
  ...
  const url = `https://hostel-system.onrender.com/room`;
  ...
  const handleDelete = () => {
    const url = `https://hostel-system.onrender.com/room/${id}`;
    fetch(url, {
      method: "DELETE",
      headers: {
        authorization: `Bearer ${localStorage.getItem("accessToken")}`,
                  ...
                  <tr key={products._id}>
                    ...
                    <td>
                      <label
                        ...
                        className="btn btn-md bg-white text-black hover:bg-rose-600 hover:border-0 hover:text-white"
                      >
                        Delete
                      </label>
                    </td>
