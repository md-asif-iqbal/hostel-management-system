...
const TravelExperience = () => {
    return (
        <div>
            <section class="py-6 dark:bg-gray-800 text-gray-50">
            <h1 class="text-center text-4xl font-bold mt-4">Our <span class="text-rose-600">Travel Experience</span>  after Final</h1>
